...
class fragment_ContenidoBicep : Fragment(R.layout.fragment__contenido_bicep) {
    private val db: FirebaseFirestore = FirebaseFirestore.getInstance()
    private val collectionReference: CollectionReference = db.collection("EjerciciosBrazoBicep")
