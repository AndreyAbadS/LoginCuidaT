...
class fragment_ContenidoTricep : Fragment(R.layout.fragment__contenido_tricep) {
    private val db: FirebaseFirestore = FirebaseFirestore.getInstance()
    private val collectionReference: CollectionReference = db.collection("EjerciciosBrazoPecho")
